...
4. Create the `.env` file (`nano .env`) and add your database URL:
   ...
   `FRONTEND_URL="https://your-frontend-app.pages.dev"`
   `PORT=5000`
...
- **CORS**: Ensure the `FRONTEND_URL` in your backend `.env` matches your actual Cloudflare Pages deployment URL exactly.
